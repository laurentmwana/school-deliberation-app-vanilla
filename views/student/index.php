...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">Gestion des étudiants</h2>
            <p class="text-muted">Ajoutez et gérez les étudiants de votre établissement</p>
        </div>
                        ...
                        <?php if (empty($students)): ?>
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    ...
                                    <p class="text-muted">Aucun étudiant n'a encore été ajouté</p>
                                    <a href="<?= route('student.create') ?>" class="btn btn-primary mt-2">Ajouter votre premier étudiant</a>
                                </td>
                            </tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($student['student_firstname']) ?></td>
                                <td><?= $student['student_gender'] === 'M' ? 'Masculin' : 'Féminin' ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="text-muted"><?= ago($student['student_created_at'] ?? new DateTime()) ?></div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-end gap-2 pe-3">
                                        <a href="<?= route('student.show', ['id' => $student['student_id']]) ?>" class="btn btn-sm btn-outline-primary d-flex align-items-center">
                                        ...
                                        <a href="<?= route('student.edit', ['id' => $student['student_id']]) ?>" class="btn btn-sm btn-outline-secondary d-flex align-items-center">
                                        ...
                                        <form method="post" action="<?= route('student.destroy', ['id' => $student['student_id']]) ?>" onsubmit="return confirm('Voulez-vous vraiment supprimer cet étudiant ? Cette action est irréversible.');">
