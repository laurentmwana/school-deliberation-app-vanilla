        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm">
                <div class="card-header bg-light py-3">
                    <h2 class="h5 mb-0">Edition d'un cours</h2>
                </div>
                <div class="card-body">
                    <form action="<?= route('course.update', ['id' => $courseId])?>" method="post">
                        <div class="mb-3">
                            <?= input('name', 'text', $course['name'], 'Nom du cours') ?>
                            <div class="form-text">Le nom complet du cours (ex. Analyse mathématique)</div>
                        </div>
                        
                        <div class="mb-4">
                            <?= input('credits', 'number', $course['credits'], 'Crédits') ?>
                            <div class="form-text">Nombre de crédits attribués à ce cours</div>
                        </div>

                        <div class="mb-4">
                            <?= select('level_id', $levels, $course['level_id'], 'Niveau / Classe') ?>
